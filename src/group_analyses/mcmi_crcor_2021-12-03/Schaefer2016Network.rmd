---
title: "MC vs MI wave 1 :: ttypes: `r params$ttype_subset`, prewh: `r params$prewh`"
output: 
    html_document:
        toc: true
        toc_depth: 2
...
#render_report(name = "Schaefer2016Network", src_dir = "group_analyses/mcmi_crcor_2021-12-03", params = list(ttype_subset = "bias", prewh = "none"))
#render_report(name = "Schaefer2016Network", src_dir = "group_analyses/mcmi_crcor_2021-12-03", params = list(ttype_subset = "pc50", prewh = "none"))
library(knitr)
library(dplyr)
library(tidyr)
library(ggplot2)

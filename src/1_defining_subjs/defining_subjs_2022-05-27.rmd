...
d <- fread(here("in", "behavior-and-events_stroop_2022-05-27_nice.csv"))
#d1 <- fread(here("in", "behavior-and-events_stroop_2021-10-20_nice.csv"))
...
subjs_fmri <- fread(here("in", "subjs", paste0("subjlist_fmri_all_", Sys.Date(), ".txt")))
subjs_fmri$wave <- paste0("wave", subjs_fmri$dmcc - 1)
...
## twins
source("/data/nil-external/ccp/JosetAEtzel/DMCC_files/getPairs.R")
...
fwrite(out, here("out", paste0("subjlist_2022-05-27.csv")))
